...
export class AboutComponent {
  ...
  public aboutEntries: AboutEntry[] = [
    ...
    new AboutEntry('How is data gathered?',
      ...
      <span>The energy usage data seen in the dashboard is gathered by Wattness via sensors in the fuse box.</span>'),
  ...
  constructor(
    ...
    if (currUser.userHasForumAccess()) {
      this.aboutEntries.push(new AboutEntry('How are points earned?',
      'trophy',
      ...
      <ul>\
        ...
        <li>Scoring one time only bonus points with <b>achievements</b></li>\
      </ul>\
